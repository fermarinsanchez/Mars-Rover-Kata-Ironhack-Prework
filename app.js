...
// save max grid length in a constant:

const maxGridLength = 10;
...
function moveForward(rover){
  ...
  if ( rover.position.x >= 0 && rover.position.x < maxGridLength && rover.position.y >= 0 && rover.position.y < maxGridLength ){
...
console.log(roverCommands(roverTwo,"rfffffff"));
console.log(roverCommands(roverOne,"rrfff"));
